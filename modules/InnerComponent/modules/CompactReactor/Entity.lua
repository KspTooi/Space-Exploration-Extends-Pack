...
--[[        smoke =
    ...
    idle_animation = {
        layers = {
            ...
            {
                filename = db.forRes("CompactReactor/res/reactor-shadow.png"),
                width = 263,
                height = 162,
                shift = { 1.625 , 0 },
                draw_as_shadow = true,
                hr_version =
                {
                    filename = db.forRes("CompactReactor/res/hr-reactor-shadow.png"),
                    width = 525,
                    height = 323,
                    scale = 0.5,
                    shift = { 1.625, 0 },
    ...
    animation = {
        layers =
        {
            ...
            {
                filename = db.forRes("CompactReactor/res/hr-reactor-lights-color.png"),
                priority = "extra-high",
            ...
            {
                filename = db.forRes("CompactReactor/res/hr-reactor-lights-color_cyan.png"),
                priority = "extra-high",
